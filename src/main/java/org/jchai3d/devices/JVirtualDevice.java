...
public class JVirtualDevice extends JGenericHapticDevice {
    ...
    public JVirtualDevice() {
        ...
        try {
            virtualLib =
                    (VirtualDeviceLibrary) Native.loadLibrary(
                    "VirtualDevice",
                    VirtualDeviceLibrary.class);
        } catch (Exception ex) {
            ex.printStackTrace();
            return;
        }
    ...
    public static class JVirtualDeviceData extends Structure {
        ...
        public static class ByValue extends JVirtualDeviceData implements Structure.ByValue {
        }
